...
class MyCustomHeader(Packet):
    ...
    fields_desc = [
        ...
        IPField("src", "148.252.146.157"),          # Source IP address
        IPField("dst", "128.110.217.195")           # Destination IP address
    ]
...
def main():
    ...
    sniff(filter="ip and src host 148.252.146.157", iface="eno1", prn=handle_packet)
